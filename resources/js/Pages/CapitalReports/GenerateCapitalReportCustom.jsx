...
export default function GenerateCapitalReportCustom({ auth }) {
    ...
    const handleGenerate = () => {
        ...
        router.visit(`/generate-capital-report/custom?from=${from}&to=${to}`);
    };

    return (
        <AuthenticatedLayout user={auth.user}>
            <Head title="Custom Capital Report" />

            <div className="max-w-3xl mx-auto mt-10 p-6 bg-white rounded-xl border border-[#d7bfa0]">
                <h1 className="text-2xl font-bold mb-6">Custom Capital Report</h1>
